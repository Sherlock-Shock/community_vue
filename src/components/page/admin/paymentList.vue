	...
	<div>
		...
		<div class="container">
			<div class="handle-box">
				查询：
				<el-input v-model="querydata.paymentId" placeholder="费用单ID" class="handle-input mr10"></el-input>
			...
			>
			    <el-table-column prop="paymentId" label="缴费单ID" width="160" ></el-table-column>
			    <el-table-column prop="payItemType" label="费用项类型" width="130"></el-table-column>
				<el-table-column prop="payItemName" label="费用项名称" width="130"></el-table-column>
				<el-table-column prop="roomNo" :formatter="roomNoFormatter" label="房屋号" width="170"></el-table-column>
		...
		<el-dialog title="缴费" :visible.sync="payVisible" width="30%">
		    ...
		    <span slot="footer" class="dialog-footer">
		        ...
		        <el-button type="warning" @click="saveHandlePay">立即缴费</el-button>
		    </span>
		</el-dialog>
